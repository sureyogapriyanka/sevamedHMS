  ...
  return (
    <div className="flex h-screen w-full bg-white">
      ...
      <div className="flex-1 flex flex-col overflow-hidden w-full">
        ...
        <header className="bg-blue-50 shadow-md z-10 border-b border-blue-100">
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-lg sm:text-xl font-bold text-blue-900 truncate max-w-[150px] sm:max-w-none">Welcome, {user?.name || "Patient"}</h1>
        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 bg-blue-50 w-full">
          {activeTab === "overview" && (
                ...
                <div className="lg:col-span-2 space-y-6">
                  <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300 bg-white border-2 border-blue-200">
                    ...
                    <div className="px-6 pb-6">
                      <Button
                        className="w-full bg-white border-2 border-blue-500 text-blue-700 hover:bg-blue-50 transition-colors duration-200"
                        onClick={() => console.log("Edit Personal Information clicked")}
                      >
                ...
                <CardContent>
                  <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <Button
                            variant="outline"
                            size="sm"
                            className="hover:bg-blue-100 hover:border-blue-300 transition-colors duration-200 border-2 border-purple-500/30 hover:shadow-md transition-shadow bg-gradient-to-br from-gray-800 to-gray-900 backdrop-blur-sm"
                          >
                            Enabled
                          </Button>
                        </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        <Button
                          className="w-full justify-between bg-white border-2 border-blue-500 text-blue-700 hover:bg-blue-50 transition-colors duration-200"
                        ...
                        <Button
                          className="w-full justify-between bg-white border-2 border-red-500 text-red-600 hover:bg-red-50 hover:border-red-600 transition-colors duration-200"
                          onClick={() => console.log("Logout from all devices clicked")}
                        >
